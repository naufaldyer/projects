...
dag = DAG(
    'data_engineering_project_rio_2',
...
SQL_QUERY = """
select * from db_flight.flight_tickets ft
"""
...
load_to_bq = GCSToBigQueryOperator(
    ...
    destination_project_dataset_table='etl_workshop_rio.flight_tickets_raw',
    schema_fields=[
...
extract_mysql >> load_to_bq >> l2_transform >> l3_transform