...
dag = DAG(
    'data_engineering_project_satrio',
...
# 	searchTime,
# 	formattedSearchTime
# from db_flight.flight_tickets ft  LIMIT 10
# """
SQL_QUERY = """
select  
	*
...
load_to_bq = GCSToBigQueryOperator(
    ...
    destination_project_dataset_table='etl_workshop_satrio.flight_tickets_raw',
    schema_fields=[
...
l2_transform = BashOperator(
    task_id='l2_transform_satrio',
    bash_command='cd /home/tsabitghazian/airflow_demo/ws2dbt/dbt_partnatech && dbt run -s l2_transform_satrio',
    dag=dag,
)

l3_transform = BashOperator(
    task_id='l3_transform_satrio',
    bash_command='cd /home/tsabitghazian/airflow_demo/ws2dbt/dbt_partnatech && dbt run -s l3_transform_satrio',
    dag=dag,
)
l4_transform = BashOperator(
    task_id='l4_transform_satrio',
    bash_command='cd /home/tsabitghazian/airflow_demo/ws2dbt/dbt_partnatech && dbt run -s l4_transform_satrio',
    dag=dag,
)
