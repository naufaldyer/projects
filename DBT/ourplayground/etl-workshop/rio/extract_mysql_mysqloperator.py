...
dag = DAG(
    'data_engineering_project_rio_1',
...
load_to_bq = GCSToBigQueryOperator(
    ...
    destination_project_dataset_table='etl_workshop.flight_tickets_raw',
    schema_fields=[
...
l2_transform = BashOperator(
    ...
    bash_command='cd /home/tsabitghazian/airflow_demo/ws2dbt/dbt_partnatech && dbt run -s l2_transform',
    dag=dag,
)

l3_transform = BashOperator(
    task_id='l3_transform',
    bash_command='cd /home/tsabitghazian/airflow_demo/ws2dbt/dbt_partnatech && dbt run -s l3_transform',
    dag=dag,
)

l4_transform = BashOperator(
    task_id='l4_transform',
    bash_command='cd /home/tsabitghazian/airflow_demo/ws2dbt/dbt_partnatech && dbt run -s l4_transform',
    dag=dag,
)
